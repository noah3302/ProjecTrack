...
class Task(BusinessObject):
    ...
    def set_phasen_id(self, phasenid):
        return self._phasen_id = phasen_id

    def __str__(self):
        return "task_id: {}\ntaskname: {}\nbeschreibung: {}\nenddatum: {}\nuser_id: {}\nphasen_id {}\n".format(self.get_id(),
                                                                                    self._taskname,self._beschreibung,
                                                                                    self._enddatum, self._user_id, self._phasen_id)
